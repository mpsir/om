(function(e){typeof define=="function"&&define.amd?define(e):e()})(function(){"use strict";const Frame={Version:11};function setItem(e,n){localStorage.setItem(e,JSON.stringify(n))}async function install(){setItem("Pages",[{name:"Home",data:`{
  "Libs": [
    "jq-ui",
    "material-icons",
    "roboto",
  ...
  "VApp": {
    ...
    "components": {
      ...
      "logged-out": "logged-out"
        ...
        }`}]),setItem("Components",[{name:"i-frame",data:`{
  "VApp": {
...
}`}]),setItem("Directives",[]),setItem("UsePlugins",[]),setItem("Mixin",[]),setItem("Composable",[]),setItem("Templates",[])}var TargetURL_1=JSON.parse(JSON.stringify(g.TargetURL)),GitURL="https://mpsir.github.io/om",T1=TargetURL_1,T2=!1;TargetURL_1=="http://super1mpsir-57484.portmap.host:57484"?T1=GitURL:(T1=TargetURL_1,T2=!0),g.f={GetDomResult:function(e){var n=g.StringifyXML.serializeToString(e);return n=n.replace(' xmlns="http://www.w3.org/1999/xhtml"',""),n},isCrome:function(){return navigator.userAgent.indexOf("Chrome")!=-1},S:function(e,n={space:2}){return g.serialize(e,n)},P:function(e){return g.deserialize(e)},PS:function(e,n={space:2}){return g.deserialize(g.serialize(e,n))},getType:function(e){switch(Object.prototype.toString.call(e)){case"[object RegExp]":return"regexp";case"[object Map]":return"map";case"[object Set]":return"set";case"[object Array]":return"array";case"[object Date]":return"date";case"[object Object]":return"object";case"[object Null]":return"null";case"[object Function]":return"function";case"[object Undefined]":return"undefined";default:return typeof e}},objectToKeyArray:function(n){var n=g.f.PS(n),r=[];return Object.entries(n).forEach(function(u,o){r.splice(r.length+1,0,{id:o,name:u[0],data:u[1]})}),r},KeyArrayToObject:function(n){var n=g.f.PS(n),r={};return n.forEach(function(t,u){r[t.name]=t.data}),r},ArrayToKeyArray:function(n){var n=g.f.PS(n),r=[];return n.forEach(function(t,u){r.splice(r.length+1,0,{id:u,name:u,data:t})}),r},KeyArrayToArray:function(n){var n=g.f.PS(n),r=[];return n.forEach(function(t,u){r[u]=t.data}),r},generateUID:function(e=16){for(var n=globalThis.randomBytes(e),r="id",t=0;t<e;++t)r+=n[t].toString(16);return r},dup:function(e,n){var r=g.f.PS(e[n]);r.hasOwnProperty("name")&&(r.name=r.name+"_dup"),e.splice(n+1,0,r)},RandomId:function(){return"id-"+Date.now()},ArrayMove:function(e,n,r){if(r>=e.length)for(var t=r-e.length+1;t--;)e.push(void 0);return e.splice(r,0,e.splice(n,1)[0]),e},ObjToArray:function(e){return Object.entries(e)},ArrayToObj:function(e){return Object.fromEntries(e)},GetTimeStamp:function(){var e=new Date;return e.getDate()+"/"+(e.getMonth()+1)+"/"+e.getFullYear()+" @ "+e.getHours()+":"+e.getMinutes()+":"+e.getSeconds()},GetFile:function(e,n=!1){var r=!1,t=new XMLHttpRequest;return t.withCredentials=!0,t.onreadystatechange=function(){this.readyState==4&&this.status==200&&(r=this.responseText)},t.open("GET",e,n),t.send(),r},GetLocalSpace:function(){var e="";for(var n in window.localStorage)window.localStorage.hasOwnProperty(n)&&(e+=window.localStorage[n]);return e?3+e.length*16/(8*1024)+" KB":"Empty (0 KB)"},PageRefresh:async function(){console.clear(),console.log(`

Refreshing Page

`),g.App&&(await g.App_Wrapper.unmount(),$("#app-div").removeAttr("data-v-app"),g.f.CreatePage())},PageChangeTo:async function(e){console.clear(),console.log("Changing Page To ",e),g.App&&(await g.App_Wrapper.unmount(),$("#app-div").removeAttr("data-v-app")),g.f.GetPageNames().find(function(r){return r.name==e})?g.f.CreatePage(e):g.f.CreatePage("404")},GetPageNames:function(){return JSON.parse(localStorage.getItem("Pages"))},GetCurrentPageName:function(){const e=location.search;if(e=="")return"Home";const n=new URLSearchParams(e).get("page");return n&&g.f.GetPageNames().find(function(t){return t.name==n})?n:"404"},GetPageData:function(e){return g.f.GetPageNames().find(function(n){return n.name==e}).data},AppDelete:async function(e=!0,n=!0){console.log("deleting frame ..."),e?localStorage.clear():localStorage.removeItem("Frame_VP"),e||localStorage.removeItem("User"),n&&location.reload()},addScripts:function(){var e=["JS_CoreJS","JS_JQ","JS_VueDev","JS_Dexie","JS_RandomBytes","JS_Serialize"];e.forEach(n=>{let r=document.createElement("script");r.setAttribute("type","text/javascript"),r.text=localStorage.getItem(n),r.setAttribute("class","remove-me"),r.setAttribute("async",!1),r.class="remove-me",document.body.appendChild(r),r.addEventListener("load",()=>{}),r.addEventListener("error",t=>{console.log("Error on loading file",t)})})},IsInstalled:function(){return!!localStorage.getItem("Frame_VP")},IsUpgradable:function(){var e=!1;return localStorage.getItem("Frame_VP")?e=JSON.parse(localStorage.getItem("Frame_VP")).Version!==Frame.Version:e=!1,e},Install:async function(){function e(r,t){localStorage.setItem(r,g.f.GetFile(g.TargetURL+t))}[["JS_CoreJS","/Lib/core-js-bundle@3.29.1/minified.min.js"],["JS_VueDev","/Lib/vue/vue.global.min.js"],["JS_JQ","/Lib/jq/jquery.js"],["JS_Dexie","/Lib/dexie/dexie.min.js"],["JS_RandomBytes","/Lib/my-random-bytes.js"],["JS_Serialize","/Lib/my-serialize.js"]].forEach(r=>{e(r[0],r[1])}),await install(),localStorage.setItem("Frame_VP",JSON.stringify(Frame)),localStorage.setItem("User",JSON.stringify(!1)),console.log("installed finished.")},StartCommon:async function(){g.f.addScripts(),g.db=await new Dexie("Sir"),await g.db.version(1).stores({Libs:"++id, &name",css:"++id, &name",js:"++id, &name",images:"++id, &name",audios:"++id, &name",videos:"++id, &name",svg:"++id, &name",blobs:"++id, &name"}),g.d={Libs:[]},g.r=Vue.reactive({IsLive:!0,IsEditor:!1,IsConnected:!1,IsReConnected:!1,User:!1})},Start:async function(){await g.f.StartCommon(),$("body").append('<div id="app-div"></div>'),await g.f.CreatePage(),$(".remove-me").remove()},AdminStart:async function(e){console.log("VApp",e),await g.f.StartCommon(),await g.f.CreateAdminPage(e),$(".remove-me").remove()},CreatePageCommon:async function(e){if(e.VApp.hasOwnProperty("components"))for(const n in e.VApp.components)typeof e.VApp.components[n]=="string"&&(e.VApp.components[n]=g.f.GetComp(e.VApp.components[n]));e.hasOwnProperty("Libs")&&e.Libs.length&&await g.f.AddLibs(e.Libs),g.App_Wrapper=g.Vue.createApp(e.VApp),e.hasOwnProperty("Comps")&&(e.Comps.includes("Quasar")&&g.App_Wrapper.use(g.Quasar),e.Comps.includes("v-select")&&g.App_Wrapper.component("v-select",window["vue-select"]),e.Comps.includes("draggable")&&g.App_Wrapper.component("draggable",g.vuedraggable),e.Comps.includes("i-frame")&&g.App_Wrapper.component("i-frame",g.f.GetComp("i-frame")),e.Comps.includes("monaco-editor")&&g.App_Wrapper.component("monaco-editor",g.f.GetComp("monaco-editor")),e.Comps.includes("toggle-content")&&g.App_Wrapper.component("toggle-content",g.f.GetComp("toggle-content")),e.Comps.includes("j-edit")&&g.App_Wrapper.component("j-edit",g.f.GetComp("j-edit")),e.Comps.includes("array-edit")&&g.App_Wrapper.component("array-edit",g.f.GetComp("array-edit")),g.App_Wrapper.component("dom-parser",g.f.GetComp("dom-parser"))),e.hasOwnProperty("Directive")&&e.Directive.includes("resize")&&g.App_Wrapper.directive("resize",{bind:function(n,{value:r={}}){n.addEventListener("load",()=>iframeResize(r,n))},unbind:function(n){n.iFrameResizer.removeListeners()}}),g.App=g.App_Wrapper.mount("#app-div"),$("#app-div").css("display","block")},CreatePage:async function(e=g.f.GetCurrentPageName()){g.ev("var Page = "+g.f.GetPageData(e)),console.log(Page),Page.hasOwnProperty("Title")&&(document.title=Page.Title),await g.f.CreatePageCommon(Page)},CreateAdminPage:async function(e,n=g.f.GetCurrentPageName()){e.template=$("#main-html").text(),g.ev("var Page ="+g.f.GetPageData(n)),console.log(`
PageName : `,n,Page,`

`),Page.VApp=e,await g.f.CreatePageCommon(Page)},GetLib:async function(e,n){var t=(await g.db.Libs.toArray()).find(function(o){return o.name==e});if(t)return t.data;const u=g.f.GetFile(n);return await g.db.Libs.add({name:e,data:u}),u},AddLibs:async function(e){for(const r of e)switch(r){case"material-icons":g.d.Libs.find(t=>t=="material-icons")||($("head").append(`<link rel="stylesheet" data-dyn-name="material-icons" href="${T1}/Lib/material-icons/iconfont/material-icons.css">`),g.d.Libs.push("material-icons"));break;case"roboto":var n=g.d.Libs.find(t=>t=="roboto");n||(T2?$("head").append(`<link rel="stylesheet" data-dyn-name="roboto" href="${T1}/CSS/roboto-local.css">`):$("head").append(`<link rel="stylesheet" data-dyn-name="roboto" href="${T1}/CSS/roboto.css">`),g.d.Libs.push("roboto"));break;case"vue-select":g.d.Libs.find(t=>t=="vue-select")||($("head").append(`
                        ...
                        <\/script>`),g.d.Libs.push("rx-js"));break;case"vue-use":g.d.Libs.find(t=>t=="vue-use")||($("body").append(`
                            ...
                            <\/script>`),g.d.Libs.push("vue-use"));break;case"monaco-editor":g.d.Libs.find(t=>t=="monaco-editor")||($("head").append(`<link rel="stylesheet" data-name="vs/editor/editor.main" href="${T1}/Lib/monaco-editor/min/vs/editor/editor.main.css">`),$("body").append(`<script class="remove-me" async="false"> const require = { paths: { vs: '${T1}/Lib/monaco-editor/min/vs' } }; <\/script>
                            ...
                            <script class="remove-me" async="false" src="${T1}/Lib/monaco-editor/min/vs/editor/editor.main.js"><\/script>`),g.d.Libs.push("monaco-editor"));break;case"socket-io":g.d.Libs.find(t=>t=="socket-io")||($("body").append(`<script data-dyn-name="socket.io" class="remove-me" async="false">
                            ${await g.f.GetLib("socket-io",`${TargetURL_1}/Lib/socket-io-client.js`)}
                        <\/script>`),g.d.Libs.push("socket-io"));break;case"jq-ui":g.d.Libs.find(t=>t=="jq-ui")||($("head").append(`<link rel="stylesheet" href="${T1}/Lib/jq/jquery-ui.min.css">`),$("body").append(`<script class="remove-me" async="false"  src="${T1}/Lib/jq/jquery-ui.min.js" ><\/script>
                        ...
                        <\/script>`),g.d.Libs.push("vue-draggable"));break}},GetComp:function(CName){var a=g.f.P(g.localStorage.getItem("Components")).filter(function(n){return n.name==CName});if(a.length){var VApp=g.f.P(a[0].data).VApp;if(VApp.hasOwnProperty("props"))for(const property in VApp.props)VApp.props[property].hasOwnProperty("type2")&&(eval(`VApp.props[property].type = ${VApp.props[property].type2}`),delete VApp.props[property].type2);if(VApp.hasOwnProperty("components"))for(const e in VApp.components)typeof VApp.components[e]=="string"&&(VApp.components[e]=g.f.GetComp(VApp.components[e]));return VApp}else return console.log(CName+" - not found"),!1}};async function StartCommon(){g.f.IsInstalled()||await g.f.Install(),g.f.IsUpgradable()&&await g.f.AppDelete()}globalThis.AppStart=async function(){await StartCommon(),await g.f.Start()},globalThis.AdminStart=async function(e){await StartCommon(),await g.f.AdminStart(e)}});
